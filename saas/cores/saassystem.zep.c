...
PHP_METHOD(Saas_Cores_SaasSystem, start) {
	...
	ZEPHIR_CALL_METHOD(NULL, &ins, "__construct", NULL, 37, basePath);
...
PHP_METHOD(Saas_Cores_SaasSystem, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkenv", NULL, 38);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("_basePath"), basePath);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "clear", NULL, 39);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "init", NULL, 40);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "login", NULL, 41);
	zephir_check_call_status();
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "main", NULL, 42);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Saas_Cores_SaasSystem, checkEnv) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		ZVAL_COPY(&ext, _1);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "extension_loaded", &_3, 43, &ext);
		zephir_check_call_status();
...
PHP_METHOD(Saas_Cores_SaasSystem, login) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 44, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	...
	ZEPHIR_CALL_FUNCTION(&_3, "fgets", NULL, 45, &handle);
	zephir_check_call_status();
	...
	ZVAL_BOOL(&_5, 0);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "getpassword", NULL, 46, &_5);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_13, "http_build_query", NULL, 47, &fields);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 10015);
...
PHP_METHOD(Saas_Cores_SaasSystem, getPassword) {
	...
	ZEPHIR_CALL_FUNCTION(&oldStyle, "shell_exec", &_1, 29, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(stars)) {
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "stty -echo");
		ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 29, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZEPHIR_GET_CONSTANT(&_2$$3, "STDIN");
		ZEPHIR_CALL_FUNCTION(&_3$$3, "fgets", NULL, 45, &_2$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 29, &_5$$4);
		zephir_check_call_status();
		...
		while (1) {
			...
			ZEPHIR_CALL_FUNCTION(&kytu, "fgetc", &_7, 48, &_6$$5);
			zephir_check_call_status();
			if (ZEPHIR_IS_STRING_IDENTICAL(&kytu, "\n")) {
				break;
			} else {
				ZEPHIR_CALL_FUNCTION(&_8$$7, "ord", &_9, 49, &kytu);
				zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 29, &_17);
	zephir_check_call_status();
...
PHP_METHOD(Saas_Cores_SaasSystem, clear) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "system", NULL, 50, &_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Saas_Cores_SaasSystem, main) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "clear", NULL, 39);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "logo", NULL, 51);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZVAL_STRING(&_13$$3, "r");
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_14, 44, &_12$$3, &_13$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&select, "fgets", &_15, 45, &handle);
		zephir_check_call_status();
		zephir_fclose(&handle TSRMLS_CC);
		...
		if (ZEPHIR_IS_LONG(&select, 1)) {
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "downloadlicenceprocess", &_17, 52);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Saas_Cores_SaasSystem, downloadLicenceProcess) {
	...
	ZEPHIR_CALL_METHOD(&listPackage, this_ptr, "getavailablepackages", NULL, 53);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&validSelection);
	zephir_create_array(&validSelection, 2, 0 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_0);
	...
	ZVAL_STRING(&_0, "=");
	ZVAL_LONG(&_1, 80);
	ZEPHIR_CALL_FUNCTION(&_2, "str_repeat", &_3, 54, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZEPHIR_GET_CONSTANT(&_0, "PHP_EOL");
	ZEPHIR_INIT_VAR(&_4);
	...
	ZVAL_LONG(&_1, 77);
	ZEPHIR_CALL_FUNCTION(&_6, "str_pad", &_7, 55, &_5, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_8);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&listPackage), _10, _11, _9)
	{
		...
		ZVAL_LONG(&_17$$3, 77);
		ZEPHIR_CALL_FUNCTION(&_18$$3, "str_pad", &_7, 55, &_16$$3, &_17$$3);
		zephir_check_call_status();
	...
	ZVAL_STRING(&_5, "=");
	ZVAL_LONG(&_1, 80);
	ZEPHIR_CALL_FUNCTION(&_20, "str_repeat", &_3, 54, &_5, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_5);
	ZEPHIR_GET_CONSTANT(&_5, "PHP_EOL");
	ZEPHIR_INIT_VAR(&_21);
	...
	ZEPHIR_INIT_VAR(&_24);
	ZVAL_STRING(&_24, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 44, &_23, &_24);
	zephir_check_call_status();
	while (1) {
		if (!(1)) {
			break;
		...
		ZEPHIR_CALL_FUNCTION(&_26$$4, "fgets", &_27, 45, &handle);
		zephir_check_call_status();
		...
		if (_29$$4) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "downloadlicence", &_34, 56, &_33$$7);
			zephir_check_call_status();
			break;
		}
	}
...
PHP_METHOD(Saas_Cores_SaasSystem, downloadLicence) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_10, "http_build_query", NULL, 47, &fields);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 10015);
	...
	zend_print_zval(&_4, 0);
	ZVAL_LONG(&_7, 5);
	ZEPHIR_CALL_FUNCTION(NULL, "sleep", NULL, 57, &_7);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
