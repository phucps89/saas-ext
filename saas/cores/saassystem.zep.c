...
PHP_METHOD(Saas_Cores_SaasSystem, start) {
	...
	ZEPHIR_CALL_METHOD(NULL, &ins, "__construct", NULL, 25, basePath);
...
PHP_METHOD(Saas_Cores_SaasSystem, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkenv", NULL, 26);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("_basePath"), basePath);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "clear", NULL, 27);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "init", NULL, 28);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "login", NULL, 29);
	zephir_check_call_status();
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "main", NULL, 30);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Saas_Cores_SaasSystem, checkEnv) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		ZVAL_COPY(&ext, _1);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "extension_loaded", &_3, 31, &ext);
		zephir_check_call_status();
...
PHP_METHOD(Saas_Cores_SaasSystem, login) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 32, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	...
	ZEPHIR_CALL_FUNCTION(&_3, "fgets", NULL, 33, &handle);
	zephir_check_call_status();
	...
	ZVAL_BOOL(&_5, 0);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "getpassword", NULL, 34, &_5);
	zephir_check_call_status();
	...
	zephir_array_fast_append(&headers, &_8);
	ZEPHIR_CALL_FUNCTION(&ch, "curl_init", NULL, 35);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_10, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_11, 36, &ch, &_10, &_9);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 47);
	ZVAL_LONG(&_12, zephir_fast_count_int(&fields TSRMLS_CC));
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_11, 36, &ch, &_10, &_12);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_13, "http_build_query", NULL, 37, &fields);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 10015);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_11, 36, &ch, &_10, &_13);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 10023);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_11, 36, &ch, &_10, &headers);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_11, 36, &ch, &_10, &__$true);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&result, "curl_exec", NULL, 38, &ch);
	zephir_check_call_status();
	ZVAL_LONG(&_10, 2097154);
	ZEPHIR_CALL_FUNCTION(&httpCode, "curl_getinfo", NULL, 39, &ch, &_10);
	zephir_check_call_status();
...
PHP_METHOD(Saas_Cores_SaasSystem, getPassword) {
	...
	ZEPHIR_CALL_FUNCTION(&oldStyle, "shell_exec", &_1, 18, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(stars)) {
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "stty -echo");
		ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 18, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZEPHIR_GET_CONSTANT(&_2$$3, "STDIN");
		ZEPHIR_CALL_FUNCTION(&_3$$3, "fgets", NULL, 33, &_2$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 18, &_5$$4);
		zephir_check_call_status();
		...
		while (1) {
			...
			ZEPHIR_CALL_FUNCTION(&kytu, "fgetc", &_7, 41, &_6$$5);
			zephir_check_call_status();
			if (ZEPHIR_IS_STRING_IDENTICAL(&kytu, "\n")) {
				break;
			} else {
				ZEPHIR_CALL_FUNCTION(&_8$$7, "ord", &_9, 42, &kytu);
				zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "shell_exec", &_1, 18, &_17);
	zephir_check_call_status();
...
PHP_METHOD(Saas_Cores_SaasSystem, clear) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "system", NULL, 43, &_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Saas_Cores_SaasSystem, main) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "clear", NULL, 27);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "logo", NULL, 44);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZVAL_STRING(&_13$$3, "r");
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_14, 32, &_12$$3, &_13$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&select, "fgets", &_15, 33, &handle);
		zephir_check_call_status();
		zephir_fclose(&handle TSRMLS_CC);
		...
		if (ZEPHIR_IS_LONG(&select, 1)) {
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "downloadlicenceprocess", &_17, 45);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Saas_Cores_SaasSystem, downloadLicenceProcess) {
	...
	ZEPHIR_CALL_METHOD(&listPackage, this_ptr, "getavailablepackages", NULL, 46);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&validSelection);
	zephir_create_array(&validSelection, 2, 0 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_0);
	...
	ZVAL_STRING(&_0, "=");
	ZVAL_LONG(&_1, 80);
	ZEPHIR_CALL_FUNCTION(&_2, "str_repeat", &_3, 47, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZEPHIR_GET_CONSTANT(&_0, "PHP_EOL");
	ZEPHIR_INIT_VAR(&_4);
	...
	ZVAL_LONG(&_1, 77);
	ZEPHIR_CALL_FUNCTION(&_6, "str_pad", &_7, 48, &_5, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_8);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&listPackage), _10, _11, _9)
	{
		...
		ZVAL_LONG(&_17$$3, 77);
		ZEPHIR_CALL_FUNCTION(&_18$$3, "str_pad", &_7, 48, &_16$$3, &_17$$3);
		zephir_check_call_status();
	...
	ZVAL_STRING(&_5, "=");
	ZVAL_LONG(&_1, 80);
	ZEPHIR_CALL_FUNCTION(&_20, "str_repeat", &_3, 47, &_5, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_5);
	ZEPHIR_GET_CONSTANT(&_5, "PHP_EOL");
	ZEPHIR_INIT_VAR(&_21);
	...
	ZEPHIR_INIT_VAR(&_24);
	ZVAL_STRING(&_24, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 32, &_23, &_24);
	zephir_check_call_status();
	while (1) {
		if (!(1)) {
			break;
		...
		ZEPHIR_CALL_FUNCTION(&_26$$4, "fgets", &_27, 33, &handle);
		zephir_check_call_status();
		...
		if (_29$$4) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "downloadlicence", &_34, 49, &_33$$7);
			zephir_check_call_status();
			break;
		}
	}
...
PHP_METHOD(Saas_Cores_SaasSystem, getAvailablePackages) {
	...
	ZVAL_LONG(&_5, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 36, &ch, &_5, &_4);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 10023);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 36, &ch, &_5, &headers);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_6, 36, &ch, &_5, &__$true);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&result, "curl_exec", NULL, 38, &ch);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 2097154);
	ZEPHIR_CALL_FUNCTION(&httpCode, "curl_getinfo", NULL, 39, &ch, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "curl_close", NULL, 40, &ch);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&httpCode, 200)) {
...
PHP_METHOD(Saas_Cores_SaasSystem, downloadLicence) {
	...
	ZVAL_LONG(&_7, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_8, 36, &ch, &_7, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 10023);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_8, 36, &ch, &_7, &headers);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_8, 36, &ch, &_7, &__$true);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 47);
	ZVAL_LONG(&_9, zephir_fast_count_int(&fields TSRMLS_CC));
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_8, 36, &ch, &_7, &_9);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_10, "http_build_query", NULL, 37, &fields);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 10015);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_8, 36, &ch, &_7, &_10);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&result, "curl_exec", NULL, 38, &ch);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 2097154);
	ZEPHIR_CALL_FUNCTION(&httpCode, "curl_getinfo", NULL, 39, &ch, &_7);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "curl_close", NULL, 40, &ch);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&httpCode, 200)) {
	...
	zend_print_zval(&_4, 0);
	ZVAL_LONG(&_7, 5);
	ZEPHIR_CALL_FUNCTION(NULL, "sleep", NULL, 50, &_7);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
